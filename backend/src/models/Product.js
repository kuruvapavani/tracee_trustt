...
const ProductSchema = new mongoose.Schema(
  {
    ...
    // New field: createdBy to link products to the user who created them
    createdBy: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "User", // IMPORTANT: Ensure 'User' matches the name of your User model
      required: true, // Making it required ensures every product has an owner
    },
  },
  { timestamps: true }
);
